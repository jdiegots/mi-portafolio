                ...
                <div className="container" style={{ maxWidth: '800px' }}>
                    ...
                    >
                        ...
                        <div className="story-full-content" style={{ fontSize: '1.2rem', lineHeight: '1.8', color: 'var(--text-secondary)' }}>
                            ...
                            <p style={{ marginBottom: '2rem' }}>
                                En casa había dos ordenadores y yo los usaba con la confianza temeraria de alguien que todavía no sabe lo que cuesta arreglar nada. Me sentaba, abría ventanas, descargaba música y películas con el <a href="https://es.wikipedia.org/wiki/Ares_Galaxy" target="_blank" rel="noopener noreferrer" style={{ color: '#d8b4fe', fontWeight: 'bold', textDecoration: 'underline' }}>Ares</a>, trasteaba con un <strong>Photoshop de otra era</strong> y montaba mis primeros vídeos con el MovieMaker como si estuviera dirigiendo Hollywood desde un cuarto cualquiera. Con diez años llegó mi primer portátil propio, un Sony VAIO naranja que parecía una nave espacial de juguete. Yo lo miraba como si me hubieran entregado un superpoder. Y claro, con el superpoder venía la parte peligrosa: instalar cosas raras porque sí, confiar en archivos con nombres sospechosos, creer que si el icono aparecía en el escritorio entonces el universo me daba la razón. A veces salía bien. Otras veces el portátil empezaba a ir lento y yo me quedaba mirándolo como si me hubiera decepcionado un amigo. Pero siempre con la misma esperanza de fondo: la de encontrar la herramienta exacta, el editor justo, el atajo perfecto, que me dejara hacer por fin lo que en mi cabeza ya parecía posible.
                            </p>

                            <p style={{ marginBottom: '2rem' }}>
                                En esos programas yo tocaba cosas sin saber qué eran. Movía capas sin entender por qué existían, cambiaba colores porque sí y me parecía perfectamente razonable pasarme una tarde entera intentando que algo “se viera bien” sin tener la menor idea de qué significaba exactamente “bien”. Era una mezcla de <strong>intuición infantil y cabezonería estética</strong>. Si quedaba decente, yo sentía que había descubierto un secreto. Si quedaba horrible, lo volvía a intentar como si el mundo dependiera de ese archivo.
                            </p>

                            <p style={{ marginBottom: '2rem' }}>
                                Poco después descubrí el placer de <strong>ordenar información</strong>. Empecé a guardar datos de fútbol en un archivo Excel. Resultados, historiales, partidos, nombres, cifras que no importaban a nadie más que a mí. Era mi manera de construir una narrativa privada donde yo decidía qué era importante y qué no. Sin saberlo, ya estaba haciendo lo que luego haría con herramientas más serias: recopilar, limpiar, unificar criterios, corregir inconsistencias, rellenar huecos como pudiera y convertir una montaña de ruido en algo comparable y legible. Estaba intentando convertir un pequeño caos en algo legible. Una estadística dejaba de ser un número perdido entre celdas y pasaba a ser una historia diminuta con principio y final. Todo aquello lo hice a mano, con paciencia de relojero sin reloj, sin saber que más adelante una línea de código podría hacer en minutos, segundos, lo que a mí me llevó años construir con la seriedad absurda de un niño que todavía no sospecha que está entrenando para su vida adulta.
                            </p>

                            <p style={{ marginBottom: '2rem' }}>
                                La adolescencia fue un momento un poco más curioso. Crecí con las redes sociales y tuve la sensación de que ellas crecían conmigo. Con doce años abrí mi primera cuenta en lo que antes era Twitter, un sitio donde todo parecía pasar a la vez. Una jungla.
                            </p>

                            <p style={{ marginBottom: '2rem' }}>
                                Un par de años después llegó la parte más seria, aunque yo todavía no la llamara así. Era una especie de pseudo-periodista que intentaba informar sobre su equipo de fútbol. Empecé a darme cuenta de que la gente me leía de verdad. No como quien pasa por encima, sino como quien se queda un segundo más de la cuenta. Empezaron a llegar mensajes privados de cuentas que no sé cómo llamar sin exagerar, una mezcla de “medio pequeño” y “gente con una web y ganas”, y terminé redactando para espacios independientes.
                            </p>

                            <p style={{ marginBottom: '2rem' }}>
                                El salto más serio fue <a href="https://www.vavel.com/es/author/diego-tejera" target="_blank" rel="noopener noreferrer" style={{ color: '#d8b4fe', fontWeight: 'bold', textDecoration: 'underline' }}>VAVEL</a>. Ahí ya había un equipo real, un calendario, un plan semanal. Ahí no era escribir por escribir. Ahí era aprender que la escritura también puede ser oficio, ritmo y responsabilidad. Tener un sitio donde esperan tu texto cambia la manera en que te sientas a escribir.
                            </p>
                            ...
                            <p style={{ marginBottom: '2rem' }}>
                                En ese tramo aparecieron señales bastante claras de que no estaba simplemente jugando en solitario. Por un lado, hice un diseño para un amigo que jugaba en los juveniles de uno de los equipos de fútbol más grandes de Canarias y, de repente, como si alguien hubiera abierto una compuerta, otros chicos empezaron a escribirme para pedirme lo mismo. Algunos hoy están en clubes profesionales, pero entonces eran solo pibes que querían tener un diseño bonito en Instagram. Por otro lado, una de esas cuentas de Twitter sirvió para que un señor me hablara con una idea que sonaba enorme para la edad que yo tenía: levantar <a href="https://fondosegunda.com" target="_blank" rel="noopener noreferrer" style={{ color: '#d8b4fe', fontWeight: 'bold', textDecoration: 'underline' }}>un medio grande de Segunda División</a>. Éramos tres al principio. Él, otro pibe que por aquel entonces tenía la misma edad que yo —unos 15 o 16 años— y yo. Y luego se sumó mucha más gente con un talento bestial hasta convertir aquello en una referencia de la segunda categoría profesional del fútbol español.
                            </p>

                            <p style={{ marginBottom: '2rem' }}>
                                Y estos detalles, cuando eres joven, te da un golpe raro en el pecho. No es “fama” (si a aquello se le podía llamar “fama”) ni éxito. Era algo mucho más simple y más fuerte: que alguien te elija porque lo que haces le sirve, y que un archivo que tú abriste una tarde por aburrimiento tenga utilidad real en una vida que no es la tuya.
                            </p>
                            ...
                            <p style={{ marginBottom: '2rem' }}>
                                Un fin de semana, aquellos en los que me quedaba solo en Santiago, me encontré con un <a href="https://github.com/thesam73/wordle" target="_blank" rel="noopener noreferrer" style={{ color: '#d8b4fe', fontWeight: 'bold', textDecoration: 'underline' }}>repositorio en GitHub con el código del Wordle</a>. Mi obsesión por trastear con programas me llevó a la costumbre de acumular programas en el ordenador que no uso al 100 por 100, pero que me gusta tener ahí, como quien empieza a guardar cosas “por si un día”. Tenía, en una gaveta digital, el Visual Studio Code. Y, sin saber programar, me dio por abrir aquel código y pensar, con la temeridad tranquila de los curiosos, que por qué no hacerlo canario. No era “no saber un poco”, sino no saber de verdad. Abrí archivos como quien desarma un reloj sin tener la menor idea de relojería. Toqué cosas. Rompí otras. Arreglé algunas por pura suerte. Y otras porque empecé a entender el código, cómo jugaba el juego conmigo antes que yo con él. Aprendí a cómo poder coger un gran número de palabras sin tener que ir poniéndolas a mano. Metí palabras canarias, cambié detalles de la interfaz y lo publiqué.
                            </p>
                            ...
                            <p style={{ marginBottom: '2rem' }}>
                                Esa es la parte que siempre suena fácil cuando se cuenta rápido, pero por dentro fue un caos precioso. Explotó como explotan las cosas de internet, que es un modo mucho más doméstico y más raro. Gente escribiéndote por la mañana para preguntarte por qué no se había actualizado la palabra. Con entrevistas improvisadas en medios locales, como <a href="https://www.canarias7.es/sociedad/wordle-nuevo-juego-20220207143704-nt.html" target="_blank" rel="noopener noreferrer" style={{ color: '#d8b4fe', fontWeight: 'bold', textDecoration: 'underline' }}>Canarias7</a>, <a href="https://diariodeavisos.elespanol.com/2022/02/diego-tejera-el-universitario-que-ha-triunfado-con-el-wordle-canario/" target="_blank" rel="noopener noreferrer" style={{ color: '#d8b4fe', fontWeight: 'bold', textDecoration: 'underline' }}>Diario de Avisos</a>, <a href="https://www.rtve.es/play/audios/canarias-mediodia-rne/juego-wordle-ya-tiene-su-version-canaria/6367257/" target="_blank" rel="noopener noreferrer" style={{ color: '#d8b4fe', fontWeight: 'bold', textDecoration: 'underline' }}>Radio Nacional de España</a> o <a href="https://www.eldiario.es/canariasahora/sociedad/wordle-canario-juego-online-moda-version-islena-palabras_1_8735546.html" target="_blank" rel="noopener noreferrer" style={{ color: '#d8b4fe', fontWeight: 'bold', textDecoration: 'underline' }}>Canarias Ahora</a>. Con noches, también, en las que descubres que la diversión tiene responsabilidades absurdas, como tener que cambiar a las 01:00 la palabra del día en mitad de un pub hasta descubrir la manera de que fuera automático. Ahí aprendí dos cosas a la vez: lo bonito no es que algo se haga difícil, sino que lo difícil se vuelva sencillo sin perder el sentido. Que un sistema pesado se convierta en un gesto ligero. Que lo artesanal encuentre un atajo limpio. Que si lo haces bien, el atajo no solo ahorra tiempo, sino que mejora la calidad. Y que la <strong>curiosidad puede convertirse en algo real</strong>.
                            </p>

                            <p style={{ marginBottom: '2rem' }}>
                                Lo bonito de esa historia no es la viralidad. Eso se evapora. Lo bonito es que encaja con mi patrón de siempre. Yo no soy el que esperaba a saberlo todo antes de empezar. Soy el que entraba con dudas pero ahora decidido, aprendía lo básico, lo probaba en la realidad y lo empujaba hasta que dejaba de ser un experimento y se conviertía en algo usable. Esa manera de aprender tiene algo de <strong>desorden controlado y algo de oficio</strong>. Y, por mucho que uno quiera, no se enseña bien en un manual porque no empieza en la teoría, sino en la necesidad nerviosa de ver si una cosa puede funcionar. Y en la terquedad de hacer que funcione.
                            </p>

                            <p style={{ marginBottom: '2rem' }}>
                                La gente suele confundir "aprender haciendo" con "hacer sin control". Yo aprendí haciendo, sí, pero aprendí a hacer con control.
                            </p>

                            <p style={{ marginBottom: '2rem' }}>
                                Después de eso, todo empezó a verse más unido. Los diseños infantiles, las bases de datos casi obsesivas, los carteles de adolescente, los días de redes en los que intentas adivinar qué va a funcionar, el juego que se te va de las manos y te obliga a aprender más de lo que tenías previsto. Todo era la misma historia escrita con distintas herramientas. La historia de alguien que necesita <strong>tocar las cosas para entenderlas</strong> y que aprendió a tocar con criterio cuando lo que hay delante ya no es un juego.
                            </p>
